...
exports.stringify = function () {
    ...
    try {
        ...
        return '[Cannot display object:' + err.message + ']'}};exports.shallow = function(source){;const keys = Object.keys(source);for(let i = 0;i < keys.length;++i){const key = keys[i];target[key] = source[key]}return target};