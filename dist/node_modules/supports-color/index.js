...
if ('FORCE_COLOR' in env){supportLevel = parseInt(env.FORCE_COLOR,10) === 0 ? 0:(supportLevel || 1)}module.exports = process && support(supportLevel);